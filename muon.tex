\documentclass[11pt, oneside, a4paper]{article}   	% {} --> Class: article, report, book, slides
							% [] --> Options: 
...
La condizione di \textit{plateau} è importante per assicurare la massima efficienza di rivelazione possibile; una volta raggiunto il \textit{plateau}, un aumento della tensione di alimentazione coincide solamente con un incremento di rumore.  
...
\begin{table}[H]
	...
	nell'individuare il segnale voluto: l'uscita negata dei discriminatori, 
	infatti, in alcuni casi non negava il segnale stesso. Per ovviare a questo 
	problema, con riferimento all'ultima coincidenza,
	abbiamo messo il segnale $S5\vee L\vee R$ (opportunamente temporizzato)
	nell'ingresso di veto del discriminatore del 
	segnale $S1$: qualora il veto fosse attivo, l'output 
	era nullo.}
	\label{coincidenze}
\end{table}
%
